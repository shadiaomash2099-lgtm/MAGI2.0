  ...
  return (
    <div className="flex items-center gap-1 text-[7px]">
      ...
      <select
        ...
        disabled={disabled}
        className="flex-1 bg-transparent border border-amber-700/20 px-1 py-0.5 text-green-400 outline-none focus:border-amber-700/40 transition-colors text-[7px]"
      >
