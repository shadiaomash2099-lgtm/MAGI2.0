  ...
  return (
    <div className="flex flex-col items-center justify-center gap-0">
      ...
      <div className="animate-zoom-out flex flex-col items-center">
        ...
        <div className="text-red-500 text-4xl font-black text-center mt-3 tracking-[0.15em]">
          NERV
        </div>
      </div>
      ...
      <div className="animate-zoom-in text-center -mt-20">
        <div className="text-red-400 text-4xl md:text-5xl font-black tracking-[0.3em] animate-text-glow">
          MAGI SYSTEM
        </div>
        <div className="text-red-400/40 text-sm mt-4 tracking-[0.3em]">
          SYSTEM READY
        </div>
      </div>
    </div>
